...
namespace {
    ...
    void add_array_multiplied(spec::BasicSpectrum &s, const Float mul, const Float *ptr)
    {
...
namespace spec {
    ...
    void SmitsUpsampler::upsample_pixel_to(const Pixel &pixel, BasicSpectrum &s) const
    {
        s = BasicSpectrum();
    ...
    void SmitsUpsampler::upsample(const Image &sourceImage, BasicSpectralImage &dest) const
    {
        init_progress_bar();
        ...
        dest = BasicSpectralImage(sourceImage.get_width(), sourceImage.get_height());
